...
- [x] Make docs/JSON/SQL exports deterministic by replacing `DateTime.now` with reproducible metadata — shared `GenerationMetadata` fingerprint powers docs/JSON/SQL headers, dedicated tests cover it, README/CHANGELOG/example assets updated, and TODO checked.
