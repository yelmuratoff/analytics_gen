...
-- Fingerprint: 53e744d999308654 (domains=3, events=10, parameters=20)
...
INSERT INTO events (id, domain_id, name, event_name, identifier, description, deprecated, replacement, added_in, deprecated_in, custom_event_name, dual_write_to, meta, source_path, line_number) VALUES (6, 1, 'verify_user', 'auth: verify_user', 'auth.verify_user', 'User verification status change', 0, NULL, NULL, NULL, NULL, NULL, NULL, '/Users/yelamanyelmuratov/Development/analytics_gen/example/events/auth.yaml', 59);
...
INSERT INTO events (id, domain_id, name, event_name, identifier, description, deprecated, replacement, added_in, deprecated_in, custom_event_name, dual_write_to, meta, source_path, line_number) VALUES (7, 2, 'cancelled', 'Purchase Flow: cancelled', 'purchase.cancelled', 'User cancelled a purchase', 0, NULL, NULL, NULL, NULL, NULL, NULL, '/Users/yelamanyelmuratov/Development/analytics_gen/example/events/purchase.yaml', 19);
...
INSERT INTO events (id, domain_id, name, event_name, identifier, description, deprecated, replacement, added_in, deprecated_in, custom_event_name, dual_write_to, meta, source_path, line_number) VALUES (8, 2, 'completed', 'Purchase Flow: completed', 'purchase.completed', 'User completed a purchase', 0, NULL, NULL, NULL, NULL, NULL, NULL, '/Users/yelamanyelmuratov/Development/analytics_gen/example/events/purchase.yaml', 3);
