...
const theme = createTheme({
  ...
  typography: {
    ...
    fontSize: 13,
    h6: { fontWeight: 700, letterSpacing: '-0.01em', color: '#1A1A1A', fontSize: '1.1rem' },
    subtitle1: { fontWeight: 600, fontSize: '0.9rem' },
    subtitle2: { fontWeight: 600, fontSize: '0.75rem', color: '#888' },
    body1: { fontSize: '0.875rem', lineHeight: 1.6 },
    body2: { fontSize: '0.82rem', lineHeight: 1.6 },
    caption: { fontSize: '0.73rem', color: '#999' },
  },
