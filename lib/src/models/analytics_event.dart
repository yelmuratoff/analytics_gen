...
final class AnalyticsEvent {
  ...
  factory AnalyticsEvent.fromMap(Map<String, dynamic> map) {
    ...
    return AnalyticsEvent(
      ...
      parameters: List<AnalyticsParameter>.from(cast<Iterable?>('parameters')?.map((x) => AnalyticsParameter.fromMap(Map.from(x as Map))) ?? const <AnalyticsParameter>[]),
      ...
      dualWriteTo: map['dual_write_to'] != null ? List<String>.from(cast<Iterable>('dual_write_to')) : null,
    );
  }
